...
export default function Intro({ detailss, visitor, setOthername }) {
  ...
  const initial = {
    ...
    archdiocese: details?.archdiocese ? details.archdiocese : "",
    diocese: details?.diocese ? details.diocese : "",
    circuit: details?.circuit ? details.circuit : "",
    local_church: details?.local_church ? details.local_church : "",
  };
  ...
  return (
    <div className="profile_card">
      ...
      {details?.archdiocese && (
        <div className="info_profile">
          <img src="../../../icons/home.png" alt="" />
          From {details?.archdiocese}
        </div>
      )}
      {details?.diocese && (
        <div className="info_profile">
          <img src="../../../icons/home.png" alt="" />
          From {details?.diocese}
        </div>
      )}
